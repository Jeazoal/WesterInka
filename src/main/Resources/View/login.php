...
require_once '../../PHP/Functions/AutenticacionUsuario.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $autenticacionUsuario = new AutenticacionUsuario($conn);
    $usuario = $autenticacionUsuario->autenticarUsuario($correo, $contrasena);  
}
?>
